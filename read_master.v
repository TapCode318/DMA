...
output reg oRM_read; //read_master yeu cau doc mem
output oFF_writerequest; // yeu cau ghi du lieu vao FF
input [31:0] iLength, iRM_startaddress, iRM_readdata; 
output reg [31:0] oFF_data, oRM_readaddress;

reg [1:0] state;// 00: dang ranh; 01: kiem tra con dia chi de doc khong; 10: dang phat lenh doc, cho bus chap nhan
